...
export const updateTravel = (id, travel) => axios.put(`http://localhost:8000/api/travel/${id}`, travel);

export const getTravel = (id) => axios.get(`http://localhost:8000/api/travel/${id}`);

export const addCommentToTravel = (id, review) => axios.post(`http://localhost:8000/api/travel/review/${id}`, review);